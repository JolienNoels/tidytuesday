...
poll %>% 
  ...
  labs(
    ...
    title = "**Change in indoor air pollution death rates and acces to clean fuels in African countries** <br>2000→2016 <br> <span style = 'color: #F68989;'>Largest reductions in indoor air pollution death rate</span>",
